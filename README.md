...
| 5 | ![](./IMG/arch.PNG) | A documentação do archlinux é um exemplo de um suporte que ajuda o usuário a compreender o sistema, a documentação é bem organizada e possui uma barra de pesquisa para facilitar a busca de informações |
